...
export const Opportunity = () => {
  const dataTD = modalitiesGames.find(
    (modality) => modality.game_id === "Tendência"
  );
    ...
    <main className={styles.containerGradient}>
      <div className={styles.introduction}>
        ...
        <div className={styles.divBtn}>
          <Link to={`/modalities?opportunity`} className={styles.button}>
            Veja tudo
          </Link>
        </div>
      </div>
