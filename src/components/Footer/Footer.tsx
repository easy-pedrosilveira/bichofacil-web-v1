      ...
      <div className={styles.footer}>
        <div className={styles.innerFooter}>
          <div className={styles.txt}>
            Lorem ipsum dolor sit amet consectetur. Urna nulla et vestibulum
            eros cursus. Rhoncus elit nunc feugiat morbi. Pellentesque mauris
            adipiscing senectus dictum commodo senectus integer. At consectetur
            id lectus amet cursus mattis dui urna enim. At sed aliquet vitae
            ...
            faucibus amet quis. Lorem in sed sapien semper vehicula eros vitae
            in.
          </div>
